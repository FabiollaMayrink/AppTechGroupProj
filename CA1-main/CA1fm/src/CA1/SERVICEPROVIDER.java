...
public abstract class SERVICEPROVIDER extends JFrame implements ActionListener {
    ...
    {//Full name
        ...
        //need be asked about the documentation from the store
        ...
        setTitle("Welcome to Gargle Delivery!");
        setSize(700, 550);
        setVisible(true);
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); 
        
        panel.setBorder(BorderFactory.createTitledBorder("Gargle Delivery CLIENT LOGIN"));
