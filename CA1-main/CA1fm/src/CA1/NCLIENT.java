...
public abstract class NCLIENT extends JFrame implements ActionListener {
    ...
    JPanel panel;
    JLabel user_label, password_label, password_label2, message, fullName, email, phoneNumber, identityDoc;
    JTextField userName_text, fullNameText, emailText, phoneNumberText, identityDocText;
...
//        JLabel DOC = new JLabel("SELECT DOC");   
//        String[] identityDoc = {"Passport", "driving licence", "ID Card"};
//        final JComboBox<String> sr = new JComboBox<String>(identityDoc);
//        panel.add(DOC);
